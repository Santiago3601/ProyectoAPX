...
/**
 * Test for transaction CCOLT00401COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CCOLT00401COTest.xml" })
public class CCOLT00401COTransactionTest {

	@Autowired
	private CCOLT00401COTransaction transaction;
