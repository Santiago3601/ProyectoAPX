...
/**
 * Test for transaction CCOLT00501COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CCOLT00501COTest.xml" })
public class CCOLT00501COTransactionTest {

	@Autowired
	private CCOLT00501COTransaction transaction;
