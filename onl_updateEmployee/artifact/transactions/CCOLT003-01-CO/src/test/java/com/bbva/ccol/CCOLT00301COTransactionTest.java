...
/**
 * Test for transaction CCOLT00301COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CCOLT00301COTest.xml" })
public class CCOLT00301COTransactionTest {

	@Autowired
	private CCOLT00301COTransaction transaction;
